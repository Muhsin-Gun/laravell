<header class="fixed top-0 w-full z-50 bg-black/80 backdrop-blur-2xl border-b border-cyan-500/20">
    <div class="max-w-7xl mx-auto px-4 py-4">
        <div class="flex items-center justify-between">
            <a href="{{ Route::has('home') ? route('home') : url('/') }}" class="flex items-center gap-3 group">
            ...
            <nav class="hidden lg:flex gap-6">
                <a href="{{ Route::has('home') ? route('home') : url('/') }}" class="text-sm text-slate-300 hover:text-cyan-400 transition">Home</a>
                <a href="{{ Route::has('cars.index') ? route('cars.index') : '#' }}" class="text-sm text-slate-300 hover:text-cyan-400 transition">Fleet</a>
                <a href="#" class="text-sm text-slate-300 hover:text-cyan-400 transition">Services</a>
            </nav>

            <div class="flex items-center gap-3">
                <a href="{{ Route::has('checkout') ? route('checkout') : '#' }}" class="relative p-2 hover:bg-white/5 rounded-lg transition group">
