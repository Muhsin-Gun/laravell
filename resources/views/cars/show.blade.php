    ...
    <div class="grid md:grid-cols-2 gap-10">
        ...
        <div>
            ...
            <div class="flex items-baseline gap-2 mb-6">
                <span class="text-5xl font-black text-transparent bg-clip-text bg-gradient-to-r from-green-400 to-emerald-400">KSH {{ number_format($car->price_per_day, 0) }}</span>
                            ...
                            <div class="space-y-4">
                                ...
                                <div class="pt-4 border-t border-slate-700">
                                    <div class="flex justify-between mb-2">
                                        ...
                                        <span class="text-white">KSH {{ number_format($car->price_per_day, 0) }}</span>
                                    </div>
                                    ...
                                    <div class="flex justify-between text-lg font-bold pt-2 border-t border-slate-700" id="totalRow" style="display: none;">
                                        ...
                                        <span class="text-green-400" id="totalPrice">KSH 0</span>
                                    </div>
                                </div>
    ...
    function calculateTotal() {
        if (startDate.value && endDate.value) {
            ...
            if (days > 0) {
                ...
                totalPrice.textContent = 'KSH ' + (days * pricePerDay).toLocaleString('en-US', {minimumFractionDigits: 0});
            }
        }
    }
